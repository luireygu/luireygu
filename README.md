...
Actualmente continúo fortaleciendo mis habilidades en **QA Automation y API Testing**, con el objetivo de crecer profesionalmente y aportar valor en proyectos reales.

---

## 🧠 Sobre mí

- 💻 Experiencia en **QA funcional**
- 🤖 Enfoque en **automatización de pruebas**
- 🧪 Testing de **APIs REST** y **aplicaciones web**
- 📚 Aprendizaje continuo y mejora constante
- 🚀 Proyectos personales como parte de mi portafolio profesional
...
Si alguno de mis proyectos te resulta útil, ¡no olvides dejar una estrella!
